Template.MobileFacebookLoginGamble.events({
...
Template.MobileFacebookLoginGamble.helpers({
...
Template.MobileFacebookLoginSports.events({
  // Login using the accounts system
  'click #alternative-login':function(){
      App.track("From FB to Email Login");
      Router.go('mobile.login')
...
Template.MobileFacebookLoginSports.helpers({
...
Template.MobileFacebookLoginCompetition.events({
  // Login using the accounts system
  'click #alternative-login':function(){
      App.track("From FB to Email Login");
      Router.go('mobile.login')
...
Template.MobileFacebookLoginCompetition.helpers({
